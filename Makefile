...
# These definitions are from config.sh (via /usr/local/lib/perl5/i586-linux/Config.pm)
CC = cc
LIBC = /usr/lib/libc.a
LDFLAGS = 
LDDLFLAGS = -shared
...
INSTALLARCHLIB = /usr/local/lib/perl5/i586-linux
INSTALLBIN = /usr/local/bin

# Perl library to use when building the extension
PERL_LIB = /usr/local/lib/perl5
PERL_ARCHLIB = /usr/local/lib/perl5/i586-linux
LIBPERL_A = libperl.a
...
PERL_INC = /usr/local/lib/perl5/i586-linux/CORE
# Perl binaries
...
CCCMD = $(CC) -c -D__USE_BSD_SIGNAL -Dbool=char -DHAS_BOOL -O6
...
$(INST_LIBDIR)/CGI.pm: CGI.pm Makefile $(INST_LIBDIR)/.exists
	@ rm -f $@
	cp CGI.pm $@
	$(CHMOD) 644 $@
	@echo $@ >> $(INST_ARCHAUTODIR)/.packlist
...
MAP_PERLINC   = -I./blib -I./blib -I/usr/local/lib/perl5/i586-linux -I/usr/local/lib/perl5
MAP_STATIC    = ./blib/auto/CGI/CGI.a /usr/local/lib/perl5/i586-linux/auto/DynaLoader/DynaLoader.a
MAP_PRELIBS   = -lgdbm -ldbm -ldb -ldl -lm -lc -lbsd 

MAP_LIBPERL = /usr/local/lib/perl5/i586-linux/CORE/libperl.a

extralibs.ld: ./blib/auto/CGI/extralibs.ld /usr/local/lib/perl5/i586-linux/auto/DynaLoader/extralibs.ld
	@ rm -f $@
	@ $(TOUCH) $@
	cat ./blib/auto/CGI/extralibs.ld >> $@
	cat /usr/local/lib/perl5/i586-linux/auto/DynaLoader/extralibs.ld >> $@
...
./perlmain.o: ./perlmain.c
	cd . && $(CC) -I/usr/local/lib/perl5/i586-linux/CORE -c -D__USE_BSD_SIGNAL -Dbool=char -DHAS_BOOL -O6 perlmain.c
